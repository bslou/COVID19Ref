...
<center>
  ...
  <li>Constantly wear face masks. Stand away from people. If you live in a house with others, use a different bathroom and everything different.</li>
   ...
   <div><form id = "form1"><p id = "comments"></p><br><textarea class = "ksk" id = "copy" placeholder = "Comment with others here..."></textarea><br><button style = "width: 200px; height: 30px;" class = "point" onclick = "func();">Submit comment</button></form></div>--><div><h1 style = "font-weight: 500;" id = "forum">Popular Forums on COVID</h1><br><a href = "https://www.reddit.com/r/COVID19/" class = "ol" target = "_blank">Reddit COVID-19 Forum</a><br><a href = "https://www.hsph.harvard.edu/coronavirus/covid-19-news-and-resources/covid-19-mental-health-forum-series/" class = "ol" target = "_blank">Harvard on COVID-19 Forum</a><br><a href = "https://wsma.org/WSMA/Membership/Discussion_Forums/COVID_19_Forum.aspx" class = "ol" target = "_blank">Washington on COVID-19 Forum</a></div><br><br>
